...
parser.add_argument('--model', default='SFHformer_l', type=str, help='model name')
...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(train_dataset,
                              ...
                              sampler=RandomSampler(train_dataset, num_samples=setting['batch_size'] * 1000,
                                                    replacement=True),
    ...
    test_str = 'motion_blur_gopro_SFHformer_l'
    ...
    if not os.path.exists(os.path.join(save_dir, args.model + test_str + '.pth')):
        ...
        for epoch in tqdm(range(setting['epochs'] + 1)):
            ...
            if epoch % (10*setting['eval_freq']) == 0:
