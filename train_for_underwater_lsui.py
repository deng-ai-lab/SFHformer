...
from datasets.underwater_DataLoader import TrainData, TestData
from numpy import *
...
parser.add_argument('--exp', default='underwater', type=str, help='experiment setting')
...
def valid(val_loader_full, network):
    ...
    for batch in val_loader_full:
        ...
        ssim_full = ssim(output, target_img).mean()
...
if __name__ == '__main__':
    ...
    train_dir = '/home/jxy/projects_dir/datasets/LSUI_new/train'
    test_dir = '/home/jxy/projects_dir/datasets/LSUI_new/test'
    train_dataset = TrainData(256, train_dir)
    train_loader = DataLoader(train_dataset,
                              batch_size=setting['batch_size'],
                              sampler=RandomSampler(train_dataset, num_samples=setting['batch_size'] * 500,
                                                    replacement=True),
                              num_workers=args.num_workers,
                              pin_memory=True,
                              drop_last=True,
                              persistent_workers=True)
    test_dataset = TestData(8, test_dir)
    ...
    test_str = 'underwater_lsui_sfhformer_s'
