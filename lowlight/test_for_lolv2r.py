...
if __name__ == '__main__':
    ...
    network.load_state_dict(torch.load('/home/jxy/projects_dir/lol/sfhformer_22422_lolv2r.pth')['state_dict'])

    train_data_dir = '/home/jxy/projects_dir/datasets/LOLv2/Real_captured/Train'
    test_data_dir = '/home/jxy/projects_dir/datasets/LOLv2/Real_captured/Test'
