...
from datasets.ITS_DataLoader import TrainData, ValData, TestData
from numpy import *
...
parser.add_argument('--exp', default='haze', type=str, help='experiment setting')
...
if __name__ == '__main__':
    ...
    train_data_dir = '/home/jxy/projects_dir/datasets/ITS/'
    val_data_dir = '/home/jxy/projects_dir/datasets/ITS/'
    test_data_dir = '/home/jxy/projects_dir/datasets/SOTS/indoor/'
    train_dataset = TrainData(256, train_data_dir)
    ...
    if not os.path.exists(os.path.join(save_dir, args.model + test_str + '.pth')):
        ...
        for epoch in tqdm(range(setting['epochs'] + 1)):
            train_loss = train(iter(train_loader), network, criterion, optimizer)
