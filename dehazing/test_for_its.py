...
from datasets.ITS_Dataloader import TrainData, ValData, TestData_its
from numpy import *
...
if __name__ == '__main__':
    ...
    network.load_state_dict(torch.load('/home/jxy/projects_dir/dehazing/sfhformer_haze_its.pth')['state_dict'])
    test_data_dir = '/home/jxy/projects_dir/datasets/SOTS/indoor/'
    test_dataset = TestData_its(8, test_data_dir)
